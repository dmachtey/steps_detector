...
#
# Last-Updated: Wed May 20 07:08:19 2026 (-0300)
#           By: Damian Machtey
#+LATEX_CLASS: article
...
file:~/tmp/steps-detect/steps_detector/media/ESP32-S3-Touch-AMOLED-1.8.webp
...
#+NAME: fig:pinout
#+ATTR_LaTeX: :width 0.6\textwidth\textwidth :options angle=0 :placement [H]
file:~/tmp/steps-detect/steps_detector/media/ESP32-S3-Touch-AMOLED-1.8-pinout.webp

#+CAPTION: Dimensiones
#+NAME: fig:dim
#+ATTR_LaTeX: :width 0.6\textwidth\textwidth :options angle=0 :placement [H]
file:~/tmp/steps-detect/steps_detector/media/ESP32-S3-Touch-AMOLED-1.8-size.webp
